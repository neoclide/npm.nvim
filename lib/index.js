...
let NpmPlugin = (_dec = (0, _neovim.Plugin)({ dev: !!process.env.NVIM_NODE_HOST_DEBUG }), _dec2 = (0, _neovim.Function)('NpmPackages', { sync: true }), _dec3 = (0, _neovim.Function)('NpmUsedModules', { sync: true }), _dec4 = (0, _neovim.Function)('NpmScripts', { sync: true }), _dec(_class = (_class2 = class NpmPlugin {
...
}, (_applyDecoratedDescriptor(_class2.prototype, 'npmPackages', [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, 'npmPackages'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'npmUsedModules', [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, 'npmUsedModules'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'npmScripts', [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, 'npmScripts'), _class2.prototype)), _class2)) || _class);
